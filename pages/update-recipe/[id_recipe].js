...
function updateRecipeData({ token, id_recipe }) {
  ...
  const postData = async (e) => {
    ...
    await axios.put(
      `${process.env.URL_BASE}/recipe/edit-recipe/${id_recipe}`,
      data,
      user
    );
    Swal.fire("Success", "Put Recipes Success", "success");
    // dispatch(updateRecipeDataData(data));
  };
  return (
    <div>
      <NavbarAfter />
